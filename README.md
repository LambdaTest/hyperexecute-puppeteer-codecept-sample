...
[<img alt="Run in Gitpod" width="200 px" align="center" src="images/Gitpod.svg" />](https://hyperexecute.lambdatest.com/hyperexecute/jobs?type=gitpod&framework=CodeceptJS&frameworkType=Puppeteer)
---
...
# How to run Puppeteer automation tests on HyperExecute (using Puppeteer-CodeceptJs framework)

* [Pre-requisites](#pre-requisites)
   - [Download HyperExecute CLI](#download-hyperexecute-cli)
   - [Configure Environment Variables](#configure-environment-variables)

* [Auto-Split Execution with Puppeteer-CodeceptJs](#auto-split-execution-with-Puppeteer-CodeceptJs)
   - [Core](#core)
   - [Pre Steps and Dependency Caching](#pre-steps-and-dependency-caching)
   - [Artifacts Management](#artifacts-management)
   - [Test Execution](#test-execution)

* [Matrix Execution with Puppeteer-CodeceptJs](#matrix-execution-with-Puppeteer-CodeceptJs)
   - [Core](#core-1)
   - [Pre Steps and Dependency Caching](#pre-steps-and-dependency-caching-1)
   - [Artifacts Management](#artifacts-management-1)
   - [Test Execution](#test-execution-1)

* [Run Puppeteer-CodeceptJs tests on Windows, Linux and Mac platforms](#run-Puppeteer-CodeceptJs-tests-on-windows-linux-and-mac-platforms)
